...
- `TNT_PACKAGE_00_SYSTEM_ALL.lsp`
  - Contains system helpers, global settings, standard TNT layer table, layer shortcuts, system variable setup.
...
- `TNT_PACKAGE_11_LAYER_MIGRATE_OLD_PREFIX.lsp`
  - Deprecated stub only.
  - `TNT_LAYER_MIGRATE` and `TNT_LAYER_PREFIX` were removed because the user now has a standard template.
